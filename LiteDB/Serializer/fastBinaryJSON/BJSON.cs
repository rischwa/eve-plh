...
namespace fastBinaryJSON
{
    ...
    public static class BJSON
    {
        ...
        public static byte[] ToBJSON(object obj, BJSONParameters param)
        {
            ...
            if (t == typeof(Dictionary<,>) || t == typeof(List<>) || t == typeof(IList<>))
    ...
    internal class deserializer
    {
        ...
        public object ToObject(byte[] json, Type type)
        {
            ...
            if (o is List<object>)
            {
                ...
                if (type != null && (t == typeof(List<>) || t == typeof(IList<>))) // deserialize to generic list
            ...
            if (parse is Dictionary<string, object>)
            {
                ...
                foreach (var kv in (Dictionary<string, object>)parse)
                {
                    ...
                    if (kv.Value is Dictionary<string, object>)
                        ...
                        v = CreateGenericList((IList<object>)kv.Value, t2, t1, null);
        ...
        private object CreateGenericList(IList<object> data, Type pt, Type bt, Dictionary<string, object> globalTypes)
        {
            if (pt.IsInterface && pt.Name == typeof(IEnumerable<>).Name || pt.Name == typeof(IList<>).Name)
            {
                pt = typeof (List<>).MakeGenericType(bt);
            }
        ...
        private object CreateDictionary(List<object> reader, Type pt, Type[] types, Dictionary<string, object> globalTypes)
        {
            ...
            IDictionary col = (IDictionary)Reflection.Instance.FastCreateInstance(typeof(Dictionary<,>).MakeGenericType(t1,t2));
