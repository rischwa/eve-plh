...
namespace LiteDB
{
    ...
    {
        public const int MAX_DOCUMENT_SIZE = 2048 * BasePage.PAGE_AVAILABLE_BYTES; //TODO geaendert, performance wurscht :) // limits in 1.044.224b max document size to avoid large documents, memory usage and slow performance
